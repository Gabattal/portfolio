...
for (let i = 0 ; i < count; i++){
    ...
    const x = getRandom(15);
    const y = getRandom(15);
    ...
    const tick = () => {
        ...
        for (const mesh of meshes){
            ...
            case -1:
                ...
                break;
            case -2: mesh.rotation.z = -elapsedTime * 0.3;
                break;
            case -3: mesh.rotation.x = -elapsedTime * 0.2;
                break;
            case 1:
                mesh.rotation.y = elapsedTime * 0.2;
                break;
            case 2: mesh.rotation.z = elapsedTime * 0.1;
                break;
            case 3: mesh.rotation.x = elapsedTime * 0.3;
                break;
            default : mesh.rotation.x = elapsedTime * 0.2;
            }
            index ++;
